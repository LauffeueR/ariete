...
<body>
	<a href="admcrimes.php">Voltar</a>
	<br><br>
	<table border="3">
		<thead>
			<!--colspan="8"--><th scope="col" colspan="8">Crimes reportados no bairro <?php echo $distr ?></th>
			<tr>
		...
		<tbody>
			<?php
				$result = $dbconn -> query("SELECT * FROM `crimereport` WHERE `distr`='$distr' ORDER BY `crimereport`.`dtime` DESC");
